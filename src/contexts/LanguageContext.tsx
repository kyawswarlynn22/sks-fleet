...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "booking.address": "Pickup Address",
    "booking.addressPlaceholder": "Enter your pickup address",
    ...
    "booking.step1": "Trip Details",
    "booking.step2": "Payment Deposit",
    "booking.depositTitle": "Deposit Required",
    "booking.depositDescription": "Please pay 30% deposit to confirm your booking",
    "booking.routePrice": "Route Price",
  ...
  mm: {
    ...
    "booking.address": "လိုက်ပို့ရမည့်လိပ်စာ",
    "booking.addressPlaceholder": "သင့်လိပ်စာကို ရိုက်ထည့်ပါ",
    "booking.notes": "မှတ်ချက်များ (ရွေးချယ်နိုင်)",
    "booking.notesPlaceholder": "အထူးတောင်းဆိုချက် သို့မဟုတ် အချက်အလက်များ...",
    "booking.next": "ရှေ့ဆက်ရန်",
    "booking.back": "နောက်သို့",
    "booking.submit": "ဘွတ်ကင်အတည်ပြုရန်",
    "booking.submitting": "တင်သွင်းနေသည်...",
    "booking.step1": "ခရီးစဉ်အသေးစိတ်",
    "booking.step2": "စရံငွေပေးချေရန်",
    "booking.depositTitle": "စရံငွေလိုအပ်သည်",
    "booking.depositDescription": "သင့်ဘွတ်ကင်ကို အတည်ပြုရန် ၃၀% စရံငွေပေးချေပါ",
    "booking.routePrice": "လမ်းကြောင်းစျေးနှုန်း",
